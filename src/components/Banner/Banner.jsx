                        ...
                        <div className="w-full lg:max-w-[950px] absolute top-[50%] left-[50%] -translate-x-2/4 -translate-y-2/4  text-center ">
                            ...
                            <Slider {...settings}>
                                <div className="slider-item font-inter mb-5">
                                    <h1 className='text-white text-[35px] sm:[30px] sm:pb-2.5 lg:text-[75px] font-bold leading-[120%] font-inter '>We Help brands with high quality services</h1>
                                    <p className='text-[16px] text-white sm:pt-[30PX] pt-[50px] pb-10 max-w-[620px] mx-auto px-4 lg:px-0'>There are many variations of passages of Lorem Ipsum available, but the majority  have suffered alteration in some form, by injected humour, or randomised words which don't look.</p>
