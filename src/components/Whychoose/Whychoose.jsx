        ...
        <>
            <section className='pt-[70px] lg:pt-[150px] pb-[70px] lg:pb-[106px]'>
                <div className="container">
                    ...
                    <div className="wca-content lg:flex flex-wrap items-center jusbtify-between gap-[105px] pt-[90px]">
                        <div className="wca-left max-w-[791px] grid grid-cols-2 items-center justify-between gap-[30px] lg:gap-[103px]"> 
                        ...
                        <div className="wca-right max-w-[428px] mt-8">
                            <div className="bg-img">
                                <img src={wcaBg} className='rounded-[10px]' alt="Why Choose AgenC Image" />
                            </div>
                        </div>
                    </div>
                </div>
